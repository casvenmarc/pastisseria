...
//PDFS:
import CartaEsp from "./images/CARTA_web_esp.pdf";
import CateringEsp from "./images/catering_esp.pdf";
              ...
              <Card className={classes.c1} elevation={0}>
                <HoverImage
                  ...
                  onClick={() => {
                    ...
                    history.push("/Products/Productes/pagebrioixEsp")
                    {/*setPacesp(1);
                    setPastcesp(0);*/}
                    window.scrollTo(0, 0)
                  }}
              ...
              <div maxWidth>
                <Card className={classes.c2} elevation={0}>
                  <HoverImage
                    ...
                    hoverSrc={cakeSombra}
                    onClick={() => {
                      history.push("/Products/Productes/pagepastEsp")
                      window.scrollTo(0, 0)
                      {/*setPaesp(0);
                      setPastesp(1);*/}
                    }}
